...
class stack_test_SingleFrac implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options !== null && trim($options) !== '') {
            $err['options'] = 'SingleFrac has no options so do not give any';
        }
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'SingleFrac needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'SingleFrac needs a teachers answer.';
        } else {
