...
class stack_test_CompSquare implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options === null && trim($options) === '') {
            $err['options'] = 'CompSquare needs and option';
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'CompSquare needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'CompSquare needs a teachers answer.';
        } else {
    ...
    public function cascall(
        ...
        return "ATCompSquare($sans,$tans,$options)";
    }

    public function option_meta(): array{
        return ['acceptable_types' => ['variable' => [
            'description' =>
            'The variable respect to which the completion is done.']],
            'general_description' =>

       'One needs to tell according to which variable the form has been built.'
        ];
    }
