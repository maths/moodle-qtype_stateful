...
class stack_test_Expanded implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options !== null && trim($options) !== '') {
            $err['options'] = 'Expanded has no options so do not give any';
        }
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'Expanded needs a students answer.';
        } else {
