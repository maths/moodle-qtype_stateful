...
class stack_test_PartFrac implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options === null && trim($options) === '') {
            $err['options'] = 'PartFrac has needs and option';
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'PartFrac needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'PartFrac needs a teachers answer.';
        } else {
    ...
    public function cascall(
        ...
        return "ATPartFrac($sans,$tans,$options)";
    }

    public function option_meta(): array{
        return ['acceptable_types' => ['variable' => [
            'description' =>
            'The variable respect to which the fractions are parted.']],
            'general_description' =>

'One needs to tell according to which variable the partial fraction form has been built.'
        ];
    }
