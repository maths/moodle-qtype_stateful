...
class stack_test_Sets implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options !== null && trim($options) !== '') {
            $err['options'] = 'Sets has no options so do not give any';
        }
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'Sets needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'Sets needs a teachers answer.';
        } else {
