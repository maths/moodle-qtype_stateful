...
class stack_test_SubstEquiv implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options !== null && trim($options) !== '') {
            $err['options'] = 'SubstEquiv has no options so do not give any';
        }
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'SubstEquiv needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'SubstEquiv needs a teachers answer.';
        } else {
