...
class stack_test_NumAbsolute implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options === null || trim($options) === '') {
            ...
            'NumAbsolute requires the option to define the absolute tolerance.';
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'NumAbsolute needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'NumAbsolute needs a teachers answer.';
        } else {
    ...
    public function cascall(
        ...
        return "ATNumerical($sans,$tans,ev($options,simp), \"ABSOLUTE\")";
    }
