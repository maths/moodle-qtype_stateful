...
class stack_test_StringRegExp implements stack_answertest {
    ...
    public function validate(
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'StringRegExp needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'StringRegExp needs a teachers answer.';
        } else {
