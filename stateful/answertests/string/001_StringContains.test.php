...
class stack_test_StringContains implements stack_answertest {
    ...
    public function validate(
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'StringContains needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'StringContains needs a teachers answer.';
        } else {
