...
class stack_test_GT implements stack_answertest {
    ...
    public function validate(
        ...
        if ($options !== null && trim($options) !== '') {
            $err['options'] = 'GT has no options so do not give any';
        }
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'GT needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'GT needs a teachers answer.';
        } else {
