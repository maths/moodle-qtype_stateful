...
class stack_test_UnitsStrictRelative implements stack_answertest {

    public function codename(): string {
        return 'UnitsStrictRelative';
    }
    ...
    public function validate(
     ...
     'UnitsStrictRelative requires the option to define the relative tolerance.'
            ;
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'UnitsStrictRelative needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'UnitsStrictRelative needs a teachers answer.';
        } else {
    ...
    public function cascall(
        ...
        return "ATUnitsStrictRelative($sans,$tans,ev($options,simp))";
    }
