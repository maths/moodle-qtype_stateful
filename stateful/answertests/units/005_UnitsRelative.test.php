...
class stack_test_UnitsRelative implements stack_answertest {

    public function codename(): string {
        return 'UnitsRelative';
    }
    ...
    public function validate(
        ...
        if ($options === null || trim($options) === '') {
           ...
           'UnitsRelative requires the option to define the relative tolerance.'
            ;
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'UnitsRelative needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'UnitsRelative needs a teachers answer.';
        } else {
    ...
    public function cascall(
        ...
        return "ATUnitsRelative($sans,$tans,ev($options,simp))";
    }
