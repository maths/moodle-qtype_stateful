...
class stack_test_UnitsSigFigs implements stack_answertest {
...
'UnitsSigFigs requires options to tell how many significant figures are needed and possibly how many are acceptable.'
            ;
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'UnitsSigFigs needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'UnitsSigFigs needs a teachers answer.';
        } else {
...
'UnitsSigFigs needs the students answer to be a raw input value for inspection of significant digits.'
            ;
        } else {
...
'UnitsSigFigs answertest needs the students answer to come from an Algebraic or preferably from an Units type input.'
                ;
            }
        }
