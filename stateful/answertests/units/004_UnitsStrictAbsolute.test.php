...
class stack_test_UnitsStrictAbsolute implements stack_answertest {

    public function codename(): string {
        return 'UnitsStrictAbsolute';
    }
    ...
    public function validate(
     ...
     'UnitsStrictAbsolute requires the option to define the absolute tolerance.'
            ;
        } else {
        ...
        if ($sans === null || trim($sans) === '') {
            $err['sans'] = 'UnitsStrictAbsolute needs a students answer.';
        } else {
        ...
        if ($tans === null || trim($tans) === '') {
            $err['tans'] = 'UnitsStrictAbsolute needs a teachers answer.';
        } else {
